...
Arrays match.
```
## ii. Comparing the results of other execution configurations. :
...
i. Therefore we succed in executing cuda program to Host-based array summation vs GPU-based vector summation and Explore the differences.

ii. Therefopre we successfylly executed in Making a new kernel to let each thread handle two elements and Compare the results with other execution confi gurations.
